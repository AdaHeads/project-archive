 ...
 */
class Organization_Old {
  static Organization_Old _instance;
   ...
   */
  factory Organization_Old(Uri URI) {
    assert(URI.isAbsolute());

    if(_instance == null) {
      _instance = new Organization_Old._internal(URI);
    }
    return _instance;
  }

  Organization_Old._internal(Uri URI) {
    _URL = URI.toString();
  }
...
final organization = new Organization_Old(new Uri('http://alice.adaheads.com:4242/organization?org_id='));
